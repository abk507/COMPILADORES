...
{
       0,    82,    82,    89,    81,    98,   118,   129,   138,   156,
     157,   162,   161,   186,   187,   191,   212,   233,   234,   238,
     239,   243,   264,   284,   285,   289,   290,   291,   292,   296,
     297,   301,   323,   342,   341,   367,   375,   366,   390,   395,
     389,   412,   414,   416,   418,   420,   422,   424,   426,   428,
     430,   435,   434,   485,   528,   546,   551,   556,   561,   569
};
#endif
...
static const char *const yytname[] =
{
  ...
  "programa", "$@1", "$@2", "cabecalho", "tipo", "definicoes", "define",
  "$@3", "definicao_campos", "lista_campos", "variaveis",
  "declaracao_variaveis", "lista_variaveis", "lista_comandos", "comando",
  "entrada_saida", "entrada", "saida", "atribuicao", "$@4", "selecao",
  "$@5", "$@6", "repeticao", "$@7", "$@8", "expressao", "expressao_acesso",
  "$@9", "termo", YY_NULLPTR
};
#endif
